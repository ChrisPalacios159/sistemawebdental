...
import { Eye, EyeOff, Stethoscope, Shield, Wrench } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#EAF3EA] via-[#F8FAF5] to-[#DCE8DE] p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl bg-white shadow-[0_12px_35px_rgba(201,178,74,0.35)] ring-1 ring-[#D8C866]/45 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-white via-[#FFFBE8] to-[#D8C866]/25" />
              <div className="absolute inset-[4px] rounded-[20px] border border-[#D8C866]/30" />
              ...
              <Image
                ...
                height={120}
                priority
                className="relative z-10 h-20 w-20 object-contain drop-shadow-[0_4px_7px_rgba(120,95,20,0.35)]"
              />
            </div>
          </motion.div>

          <h1 className="text-3xl font-bold text-[#2C3E2D] tracking-tight">
            Marfil Stetic
          </h1>

          <p className="text-[#8B948B] mt-1 text-sm">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label
                  htmlFor="email"
                  className="text-[#56635A] text-sm font-medium"
                >
                  Correo electrónico
                </Label>
            ...
            <div className="mt-6 pt-5 border-t border-[#D4DDD6]">
              <p className="text-xs text-[#8B948B] text-center mb-3">
                Acceso rápido (demo)
              </p>
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  onClick={() =>
                    quickLogin('admin@marfilstetic.com', 'admin123')
                  }
                ...
                >
                  ...
                  <span className="text-[10px] font-medium text-[#56635A]">
                    Admin
                  </span>
                </button>
                ...
                <button
                  onClick={() =>
                    quickLogin('doctor@marfilstetic.com', 'doctor123')
                  }
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl border border-[#D4DDD6] hover:border-[#C9B24A] hover:bg-[#C9B24A]/5 transition-all duration-200"
                >
                ...
                <button
                  onClick={() =>
                    quickLogin('tecnico@marfilstetic.com', 'tecnico123')
                  }
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl border border-[#D4DDD6] hover:border-[#C9B24A] hover:bg-[#C9B24A]/5 transition-all duration-200"
                >
